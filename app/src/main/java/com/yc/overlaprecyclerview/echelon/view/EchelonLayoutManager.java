package com.yc.overlaprecyclerview.echelon.view;
...
public class EchelonLayoutManager extends RecyclerView.LayoutManager {
    ...
    public EchelonLayoutManager(Context context) {
        ...
        mItemViewWidth = (int) (getHorizontalSpace() * 1f);//item的宽
        //        mItemViewHeight = (int) (mItemViewWidth * 1.46f);//item的高
        mItemViewHeight = (int) (mItemViewWidth * 1f);//item的高
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        mItemViewWidth = (int) (getHorizontalSpace() * 1f);
